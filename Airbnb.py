...
with col1:
    ...
    st.image(Image.open(r"C:\Users\aashi\Desktop\YoutubeProject\Airbnb_Image.png"), width=100)
...
if select == "Home":
    ...
    with col1:
        ...
        st.image(Image.open(r"C:\Users\aashi\Desktop\YoutubeProject\image-airbnb.jpg"), width=750)
...
if select == "Data Exploration":
    ...
    with tab3:
        ...
        non_numeric_cols = ["listing_url", "name", "property_type", "room_type", "bed_type", 
                            ...
                            "host_verifications", "street", "suburb",
